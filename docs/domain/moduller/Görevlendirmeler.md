...
8. **Öğretmen yükü** — Bir sezonun öğretmen yük özeti. Ders yükü **canlı ders programının** yerleşimlerinden sayılır (bir yerleşim bir ders saati), sezonun güncel dönemi üzerinden. Yüzde, öğretmenin **kişisel haftalık kapasitesine** göre hesaplanır — profilde özel değer yoksa okulun Ayarlar'daki varsayılanı uygulanır: branş öğretmeni ve sınıf öğretmeni için ayrı ayrı tutulur, okul açılışında ikisi de 40 saattir (`K-13`, `TB-243`; 2026-09-23 kararı). Sınıf öğretmeni varsayılanı yalnız okulda ilkokul kademesi açıkken uygulanır. Kadro ortalamasının paydası kadronun tamamıdır: canlı yerleşimi olmayan öğretmen ortalamaya 0 olarak girer, çünkü sorulan soru "kadro ne kadar dolu"dur. Ayrıca **ders dışı yük** saat olarak gösterilir: canlı nöbet çizelgesindeki nöbet günü ve aktif kulüp danışmanlığı, okulun katsayılarıyla (varsayılan ikisi de 2 saat) çevrilir. Bu saatler **yalnız bilgi amaçlıdır**; yük yüzdesine, aşım rozetine ve kapasite hesabına girmez (`K-15/3`) — kural kaynağında yazılıdır ki yeni bir tüketici "toplam yük" icat etmesin. **Kulüp saati bunun istisnasıdır (`Y-06`, 2026-09-25 kararı · henüz uygulanmadı):** okul kulüp saatini ders programına koyduğunda, danışman öğretmenin programdaki kulüp saati yerleşimi ders saati gibi **yük yüzdesine ve aşım rozetine girer**. Katsayılı kulüp danışmanlığı satırı ise bilgi olarak kalır, yüzdeye girmez — aynı iş yüzdede iki kez sayılmaz. Özet kısa ömürlü önbellektedir; program yayını ve sezon değişimi önbelleği tazeler.
...
### Kulüp saati ve yük (`Y-06`, 2026-09-26)

- `K-15/3` revizyonu: programdaki kulüp saati danışmanın **ders yüküne** (yüzde ve aşım rozeti) girer; `clubHourWeeklyHours` payı ayrıca görünür. Katsayılı "Kulüp danışmanlığı" satırı bilgi olarak kalır, yüzdeye girmez. Kulüp saati olmayan okulda davranış değişmez.
