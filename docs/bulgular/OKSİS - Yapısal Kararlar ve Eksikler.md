...
| **K-15** | Ders dışı yük görünürlüğü | ✅ Karara bağlandı · **uygulandı** | 2026-09-01 | Nöbet + kulüp · katsayı okul ayarı (vars. 2/2) · kapasiteye GİRMEZ — BE `225f7623` + web `oksis-ui` @ `3cc904e` · ⚠️ **2026-09-25 `Y-06` revizyonu:** programdaki kulüp saati yerleşimi yük yüzdesine girer; katsayılı satır bilgi olarak kalır |
...
> 🔁 **Revizyon (2026-09-25, `Y-06`, Faruk Kaya):** `K-15/3` kulüp saati için daraltıldı. Okul kulüp saatini ders programına koyduğunda, danışmanın programdaki kulüp saati yerleşimi ders saati gibi **yük yüzdesine ve aşım rozetine girer**. Katsayılı kulüp danışmanlığı satırı bilgi olarak kalır ve yüzdeye girmez; aynı iş iki kez sayılmaz. Nöbet için kural değişmedi. Uygulandı (2026-09-26, `TeacherClubHourLoad`, commit bekliyor) — [[kulup-saati]] §5, §11.
