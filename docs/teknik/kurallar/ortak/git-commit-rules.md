...
> Üretilmiş issue'lar (geçici issue belgeleri `oksis/docs/gecici/` altında tutulur, iş bitince silinir) implement edilirken **her issue için ayrı commit** atılır. Bu kural pazarlık konusu değildir.
...
- Her issue belgesinin sonunda zorunlu "Commit Requirement" bölümü bulunur.
