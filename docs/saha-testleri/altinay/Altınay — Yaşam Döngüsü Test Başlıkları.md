...
| B6.4 | Müdür yardımcısı hem öğretmen hem idareci — **✅ 2026-09-24 kapandı.** Müdür bir öğretmeni müdür yardımcısı belirliyor (Ayarlar › Genel Bilgiler › İdari Kadro ya da öğretmen çekmecesi › Hesap). Kişi öğretmenliği sürdürüyor; profil değiştirerek (Öğretmen ⇄ Okul Yöneticisi) müdürle aynı yetkilerle çalışıyor. Gerekçeyle görevden alınabiliyor. Altınay'da müdür Metin Kabaca gerçek müdür yardımcısını belirledi, kullanıcı ölçtü: sorunsuz. Ayrıntı: Bulgu Arşivi §60, tasarım [[mudur-yardimcisi-tasarimi]]. | ✅     | `E-29` · `TB-249` · `TB-250`|
| B6.5 | Soyadı yer tutucu olan iki öğretmen; soyadın sonradan düzeltilmesi — **✅ 2026-09-24 kapandı.** Gerçek adlar: **Hale Kübra Öztürk** (`hale.kubra.ozturk@altinay.test`) ve **Salih Demirci** (`salih.demirci@altinay.test`). Ad, soyad ve giriş e-postası birlikte güncellendi; yeni e-postayla giriş 200, eski `…soyad@` adresleri 401. **Düzeltme ekrandan yapılamadı:** kabulden sonra adı değiştiren ekran yok. Güncelleme ürünün kendi ucundan (`PUT users/persons/{id}`) müdür yetkisiyle gönderildi. Ekran eksiği `E-31` olarak açık. | ✅     | `E-31`                   |
