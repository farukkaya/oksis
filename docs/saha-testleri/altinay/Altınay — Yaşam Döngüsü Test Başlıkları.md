...
| B6.4 | Müdür yardımcısı hem öğretmen hem idareci — **yapı destekliyor, rol kataloğu desteklemiyor.** Kişi birden çok profil ve çoklu aktif rol taşıyabiliyor; ama ara rol yok: idari yetki vermek **okulun tamamına erişim** vermek demek **2026-09-24 yeniden ölçüldü:** izin aktif profile göre süzülüyor, yani iki görev aynı anda değil profil değiştirerek yaşanır. Ama müdür, müdür yardımcısına idari profil ve rol veremiyor: ekran yok, eşit seviye (`SCHOOL_ADMIN`) ataması da kuralca reddediliyor. Ayrıntı `E-29`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | ⬜     | `E-29`                   |
