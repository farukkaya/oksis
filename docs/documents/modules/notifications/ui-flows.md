...
**Konum:** `src/modules/notifications/pages/{{TBD_ComponentName}}.tsx`
...
| Key | TR |
|---|---|
| `notifications.title` | {{TBD}} |
| `notifications.empty` | Henüz {{TBD}} eklenmemiş |
| `notifications.errors.required` | Bu alan zorunludur |
