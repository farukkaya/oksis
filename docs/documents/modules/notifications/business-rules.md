# Bildirim — Business Rules

> Bu modüle özel iş kuralları. Yazılım dünyasından gelen genel kurallar değil — **OKSİS'te Bildirim için spesifik** kararlar.
...
### BR-notifications-001: {{TBD_kural_basligi}}
