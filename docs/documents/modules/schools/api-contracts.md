# Okul / Tenant Yönetimi — API Kontratları
...
|---|---|---|---|
| GET | `/api/v1/schools` | `schools.view` | Liste |
| GET | `/api/v1/schools/{id}` | `schools.view-detail` | Detay |
| POST | `/api/v1/schools` | `schools.create` | Oluştur |
| PUT | `/api/v1/schools/{id}` | `schools.update` | Güncelle |
| DELETE | `/api/v1/schools/{id}` | `schools.delete` | Sil (soft) |
