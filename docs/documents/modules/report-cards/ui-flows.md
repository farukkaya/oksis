...
**Konum:** `src/modules/report-cards/pages/{{TBD_ComponentName}}.tsx`
...
| Key | TR |
|---|---|
| `report-cards.title` | {{TBD}} |
| `report-cards.empty` | Henüz {{TBD}} eklenmemiş |
| `report-cards.errors.required` | Bu alan zorunludur |
