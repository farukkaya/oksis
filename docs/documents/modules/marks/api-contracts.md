...
|---|---|---|---|
| GET | `/api/v1/marks` | `marks.view` | Liste |
| GET | `/api/v1/marks/{id}` | `marks.view-detail` | Detay |
| POST | `/api/v1/marks` | `marks.create` | Oluştur |
| PUT | `/api/v1/marks/{id}` | `marks.update` | Güncelle |
| DELETE | `/api/v1/marks/{id}` | `marks.delete` | Sil (soft) |
