...
**Konum:** `src/modules/attendance/pages/{{TBD_ComponentName}}.tsx`
...
| Key | TR |
|---|---|
| `attendance.title` | {{TBD}} |
| `attendance.empty` | Henüz {{TBD}} eklenmemiş |
| `attendance.errors.required` | Bu alan zorunludur |
