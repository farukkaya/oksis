...
| Kod | Anlam |
|---|---|
| `dashboard.view` | Liste görüntüleme |
| `dashboard.view-detail` | Detay görüntüleme |
| `dashboard.create` | Oluşturma |
| `dashboard.update` | Güncelleme |
| `dashboard.delete` | Silme (soft) |
| `dashboard.{{TBD}}` | {{TBD}} |
...
|---|---|---|---|---|---|---|---|
| `dashboard.view` | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} |
| `dashboard.create` | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} |
| `dashboard.update` | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} |
| `dashboard.delete` | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} |
