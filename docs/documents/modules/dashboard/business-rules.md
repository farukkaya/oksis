...
> Bu modüle özel iş kuralları. Yazılım dünyasından gelen genel kurallar değil — **OKSİS'te Dashboard için spesifik** kararlar.
...
### BR-dashboard-001: {{TBD_kural_basligi}}
