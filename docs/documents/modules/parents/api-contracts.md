...
|---|---|---|---|
| GET | `/api/v1/parents` | `parents.view` | Liste |
| GET | `/api/v1/parents/{id}` | `parents.view-detail` | Detay |
| POST | `/api/v1/parents` | `parents.create` | Oluştur |
| PUT | `/api/v1/parents/{id}` | `parents.update` | Güncelle |
| DELETE | `/api/v1/parents/{id}` | `parents.delete` | Sil (soft) |
