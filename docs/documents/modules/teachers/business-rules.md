# Öğretmen — Business Rules

> Bu modüle özel iş kuralları. Yazılım dünyasından gelen genel kurallar değil — **OKSİS'te Öğretmen için spesifik** kararlar.
...
### BR-teachers-001: {{TBD_kural_basligi}}
