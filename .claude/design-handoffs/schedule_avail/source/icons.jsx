/* OKSİS — Lucide-style inline SVG icon set */
const OKSIS_ICON_PATHS = {
  ...
  'contact': '<path d="M16 18a4 4 0 0 0-8 0"/><rect width="18" height="18" x="3" y="4" rx="2"/><circle cx="12" cy="10" r="2"/><line x1="8" x2="8" y1="2" y2="4"/><line x1="16" x2="16" y1="2" y2="4"/>',
  ...
  'heart': '<path d="M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3.016 0L5 14.999c-1.5-1.5-3-3.205-3-5.499"/>',
  ...
  'star': '<path d="M11.52 2.5a.53.53 0 0 1 .96 0l2.07 4.2a.53.53 0 0 0 .4.29l4.64.67c.44.07.62.6.3.91l-3.36 3.27a.53.53 0 0 0-.15.47l.79 4.61c.08.44-.39.78-.79.57l-4.14-2.18a.53.53 0 0 0-.49 0l-4.14 2.18c-.4.21-.86-.13-.79-.57l.79-4.61a.53.53 0 0 0-.15-.47L3.4 8.57a.53.53 0 0 1 .3-.91l4.64-.67a.53.53 0 0 0 .4-.3z"/>',
  ...
  'eye-off': '<path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c4.78 0 8.77 3.2 9.94 7.65a1 1 0 0 1 0 .7 10.78 10.78 0 0 1-1.44 2.49"/><path d="M14.08 14.16a3 3 0 0 1-4.24-4.24"/><path d="M17.48 17.5A10.45 10.45 0 0 1 12 19c-4.78 0-8.77-3.2-9.94-7.65a1 1 0 0 1 0-.7A10.75 10.75 0 0 1 6.5 5.36"/><path d="m2 2 20 20"/>',
  ...
  'fingerprint': '<path d="M12 10a2 2 0 0 0-2 2c0 1.02-.1 2.51-.26 4"/><path d="M14 13.12c0 2.38 0 6.38-1 8.88"/><path d="M17.29 21.02c.12-.6.43-2.3.5-3.02"/><path d="M2 16h.01"/><path d="M21.8 16c.2-2 .131-5.354 0-6"/><path d="M5 19.5C5.5 18 6 15 6 12a6 6 0 0 1 .34-2"/><path d="M8.65 22c.21-.66.45-1.32.57-2"/><path d="M9 6.8a6 6 0 0 1 9 5.2v2"/>',
  ...
  'calendar-clock': '<path d="M21 7.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h3.5"/><path d="M16 2v4"/><path d="M8 2v4"/><path d="M3 10h5"/><circle cx="17" cy="17" r="5"/><path d="M17 14.5v2.5l1.5 1"/>',
  'file-badge': '<path d="M4 7V4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-3"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><circle cx="5" cy="14" r="3"/><path d="M5 17v3l-1.5-1L2 20v-3"/>',
  ...
  'graduation': '<path d="M21.42 10.92a1 1 0 0 0-.02-1.84L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.83l8.57 3.91a2 2 0 0 0 1.66 0z"/>',
  'cake': '<path d="M20 21v-8a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8"/><path d="M4 16s.5-1 2-1 2.5 2 4 2 2.5-2 4-2 2.5 2 4 2 2-1 2-1"/><path d="M2 21h20"/><path d="M7 8v3"/><path d="M12 8v3"/><path d="M17 8v3"/><path d="M7 4h.01"/><path d="M12 4h.01"/><path d="M17 4h.01"/>',
  'image': '<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/>',
  'paperclip': '<path d="M13.234 20.252 21 12.3a4.5 4.5 0 0 0-6.364-6.364L4.5 16.072a3 3 0 0 0 4.243 4.243l9.193-9.193"/>',
...
function Icon({ name, size = 20, strokeWidth = 2, className = '', style = {} }) {
  const inner = OKSIS_ICON_PATHS[name] || '';
  return (
    <svg
...
/* OKSİS mark — official anatomy: 56×56 container r14, four 14×14 modules r3,
   inset 11, gap 6. Active diagonal (↖↘) 100%, passive (↗↙) 60%.
   Background = 135° signature gradient. */
function OksisMark({ size = 36, radius, idSuffix = 'm' }) {
  const r = radius != null ? radius : size * (14 / 56);
  const gid = 'oksisGrad-' + idSuffix;
  return (
    <svg width={size} height={size} viewBox="0 0 56 56" style={{ display: 'block', flexShrink: 0 }} xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id={gid} x1="0" y1="0" x2="56" y2="56" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#1B2B5E" />
          <stop offset="1" stopColor="#4F6BFF" />
        </linearGradient>
      </defs>
      <rect width="56" height="56" rx="14" fill={'url(#' + gid + ')'} />
      <rect x="11" y="11" width="14" height="14" rx="3" fill="#fff" />
      <rect x="31" y="31" width="14" height="14" rx="3" fill="#fff" />
      <rect x="31" y="11" width="14" height="14" rx="3" fill="#fff" opacity="0.6" />
      <rect x="11" y="31" width="14" height="14" rx="3" fill="#fff" opacity="0.6" />
    </svg>
  );
}

Object.assign(window, { Icon, OksisMark, OKSIS_ICON_PATHS });
