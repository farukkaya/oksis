...
**Konum:** `src/modules/classrooms/pages/{{TBD_ComponentName}}.tsx`
...
| Key | TR |
|---|---|
| `classrooms.title` | {{TBD}} |
| `classrooms.empty` | Henüz {{TBD}} eklenmemiş |
| `classrooms.errors.required` | Bu alan zorunludur |
