...
|---|---|---|---|
| GET | `/api/v1/dashboard` | `dashboard.view` | Liste |
| GET | `/api/v1/dashboard/{id}` | `dashboard.view-detail` | Detay |
| POST | `/api/v1/dashboard` | `dashboard.create` | Oluştur |
| PUT | `/api/v1/dashboard/{id}` | `dashboard.update` | Güncelle |
| DELETE | `/api/v1/dashboard/{id}` | `dashboard.delete` | Sil (soft) |
