...
|---|---|---|---|
| GET | `/api/v1/identity` | `identity.view` | Liste |
| GET | `/api/v1/identity/{id}` | `identity.view-detail` | Detay |
| POST | `/api/v1/identity` | `identity.create` | Oluştur |
| PUT | `/api/v1/identity/{id}` | `identity.update` | Güncelle |
| DELETE | `/api/v1/identity/{id}` | `identity.delete` | Sil (soft) |
