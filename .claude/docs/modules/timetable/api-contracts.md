...
|---|---|---|---|
| GET | `/api/v1/timetable` | `timetable.view` | Liste |
| GET | `/api/v1/timetable/{id}` | `timetable.view-detail` | Detay |
| POST | `/api/v1/timetable` | `timetable.create` | Oluştur |
| PUT | `/api/v1/timetable/{id}` | `timetable.update` | Güncelle |
| DELETE | `/api/v1/timetable/{id}` | `timetable.delete` | Sil (soft) |
