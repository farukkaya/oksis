# Akademik Yıl / Sezon — API Kontratları
...
|---|---|---|---|
| GET | `/api/v1/academic-years` | `academic-years.view` | Liste |
| GET | `/api/v1/academic-years/{id}` | `academic-years.view-detail` | Detay |
| POST | `/api/v1/academic-years` | `academic-years.create` | Oluştur |
| PUT | `/api/v1/academic-years/{id}` | `academic-years.update` | Güncelle |
| DELETE | `/api/v1/academic-years/{id}` | `academic-years.delete` | Sil (soft) |
