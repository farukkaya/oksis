...
**İlerleme:** `███░░░░░░░` %26   ·   Status: in-progress (web spec-audit)   ·   Güncel: 2026-06-28 (güncel şube tek doğruluk kaynağı + `CurrentClassroomId` interceptor-derived — BR-students-001)
