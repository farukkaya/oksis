...
|---|---|---|---|
| GET | `/api/v1/students` | `students.view` | Liste |
| GET | `/api/v1/students/{id}` | `students.view-detail` | Detay |
| POST | `/api/v1/students` | `students.create` | Oluştur |
| PUT | `/api/v1/students/{id}` | `students.update` | Güncelle |
| DELETE | `/api/v1/students/{id}` | `students.delete` | Sil (soft) |
