...
|---|---|---|---|
| GET | `/api/v1/subjects` | `subjects.view` | Liste |
| GET | `/api/v1/subjects/{id}` | `subjects.view-detail` | Detay |
| POST | `/api/v1/subjects` | `subjects.create` | Oluştur |
| PUT | `/api/v1/subjects/{id}` | `subjects.update` | Güncelle |
| DELETE | `/api/v1/subjects/{id}` | `subjects.delete` | Sil (soft) |
