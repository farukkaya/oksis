...
|---|---|---|---|
| GET | `/api/v1/attendance` | `attendance.view` | Liste |
| GET | `/api/v1/attendance/{id}` | `attendance.view-detail` | Detay |
| POST | `/api/v1/attendance` | `attendance.create` | Oluştur |
| PUT | `/api/v1/attendance/{id}` | `attendance.update` | Güncelle |
| DELETE | `/api/v1/attendance/{id}` | `attendance.delete` | Sil (soft) |
