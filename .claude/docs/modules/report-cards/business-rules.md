# Karne — Business Rules

> Bu modüle özel iş kuralları. Yazılım dünyasından gelen genel kurallar değil — **OKSİS'te Karne için spesifik** kararlar.
...
### BR-report-cards-001: {{TBD_kural_basligi}}
