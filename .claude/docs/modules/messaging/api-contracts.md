...
|---|---|---|---|
| GET | `/api/v1/messaging` | `messaging.view` | Liste |
| GET | `/api/v1/messaging/{id}` | `messaging.view-detail` | Detay |
| POST | `/api/v1/messaging` | `messaging.create` | Oluştur |
| PUT | `/api/v1/messaging/{id}` | `messaging.update` | Güncelle |
| DELETE | `/api/v1/messaging/{id}` | `messaging.delete` | Sil (soft) |
