...
> **{{TBD}} — Faz 4'te dolacak.** Domain event'ler (`FileQuarantinedEvent` vb.) Faz 1'de tanımlandı (bkz. `domain-model.md`) ama Hangfire job'ları ve `INotificationRecipientResolver` bağlaması henüz yazılmadı (spec § 3.5).
