...
- **Bekleyen sekmeler:** Genel Bilgiler, Akademik Yapı (Ders Kataloğu), Akademik Politikalar, Zil Programı, Tatil Takvimi, Bildirim Ayarları — kullanıcı isteğiyle Derslikler sonrası **bekletiliyor** (planlar yazılacak/uygulanacak).
