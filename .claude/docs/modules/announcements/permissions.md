...
| Kod | Anlam |
|---|---|
| `announcements.view` | Liste görüntüleme |
| `announcements.view-detail` | Detay görüntüleme |
| `announcements.create` | Oluşturma |
| `announcements.update` | Güncelleme |
| `announcements.delete` | Silme (soft) |
| `announcements.{{TBD}}` | {{TBD}} |
...
|---|---|---|---|---|---|---|---|
| `announcements.view` | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} |
| `announcements.create` | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} |
| `announcements.update` | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} |
| `announcements.delete` | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} |
