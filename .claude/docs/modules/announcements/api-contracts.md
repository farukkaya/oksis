...
|---|---|---|---|
| GET | `/api/v1/announcements` | `announcements.view` | Liste |
| GET | `/api/v1/announcements/{id}` | `announcements.view-detail` | Detay |
| POST | `/api/v1/announcements` | `announcements.create` | Oluştur |
| PUT | `/api/v1/announcements/{id}` | `announcements.update` | Güncelle |
| DELETE | `/api/v1/announcements/{id}` | `announcements.delete` | Sil (soft) |
