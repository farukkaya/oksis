...
**Konum:** `src/modules/announcements/pages/{{TBD_ComponentName}}.tsx`
...
| Key | TR |
|---|---|
| `announcements.title` | {{TBD}} |
| `announcements.empty` | Henüz {{TBD}} eklenmemiş |
| `announcements.errors.required` | Bu alan zorunludur |
