...
| Kod | Anlam |
|---|---|
| `users.view` | Liste görüntüleme |
| `users.view-detail` | Detay görüntüleme |
| `users.create` | Oluşturma |
| `users.update` | Güncelleme |
| `users.delete` | Silme (soft) |
| `users.{{TBD}}` | {{TBD}} |
...
|---|---|---|---|---|---|---|---|
| `users.view` | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} |
| `users.create` | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} |
| `users.update` | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} |
| `users.delete` | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} | {{TBD}} |
